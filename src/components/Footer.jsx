...
const Footer = () => {
  return (
    <div className=" min-h-max bg-gray-300 text-white p-4 flex flex-row gap-4">
      <div className="flex flex-col gap-2 w-[30%]">
        <p className="text-2xl font-bold text-gray-600">
          Meadow <span className="text-green-600">AI</span>
        </p>
        <p className="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae doloremque autem quia fugiat, cupiditate molestias et eligendi magni quaerat aperiam,</p>
      </div>
